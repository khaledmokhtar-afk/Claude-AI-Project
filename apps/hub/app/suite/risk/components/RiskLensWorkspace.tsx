...
export function RiskLensWorkspace({
  projects,
  risks,
}: {
  ...
  const { mode, setRisks } = useWorkspace();
  ...
  const runPrediction = async () => {
    ...
    if (mode === "demo") {
      ...
      const demo = buildDemoPrediction(activeProjectId);
      setAi(demo);
      setRisks({
        projectSummary,
        portfolioInsight: demo.portfolioInsight,
        newRisks: demo.newRisks,
      });
      setIsRunning(false);
      return;
    }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-6 mt-6">
        <div className="flex flex-col gap-6">
          <div className="grid grid-cols-1 md:grid-cols-[320px_1fr] gap-6">
            ...
            <PredictionPanel
              ...
              aiForSelected={ai?.newRisks.find((r) => r.title === selectedRisk?.title)}
            />
          </div>
        ...
        <div className="flex flex-col gap-6">
          <div className="glass p-5">
            ...
            >
              {isRunning ? "Predicting…" : mode === "ai" ? "⚡ Run with Claude" : "▶ Run Predictive Model"}
            </button>
            ...
            {error && <div className="mt-3 text-xs text-[var(--color-primary-soft)]">{error}</div>}
          </div>
    ...
    "fpso-aurora": {
      newRisks: [
        ...
        },
        {
          ...
          predicted60d: 0.62,
          predicted90d: 0.70,
          description: "Gulf of Guinea security premiums are up YoY; renewal due in 45 days.",
          mitigation:
      ...
      newRisks: [
        {
          ...
          mitigation: "Confirm gas feedstock; independent adhesion test per 200m section.",
        },
        {
          ...
          predicted60d: 0.50,
          predicted90d: 0.58,
          description: "Recent NIMASA turnaround on deep-draft barges extended from 9 to 16 days.",
          mitigation: "Pre-inspection package filed; dedicated port agent; backup anchorage nominated.",
        },
        {
          ...
          mitigation: "Pre-emptive GMoU amendment; alternate skills pool identified upstream.",
        },
      ],
      portfolioInsight:
    ...
    "whp-egina": {
      newRisks: [
        ...
        },
        {
          ...
          predicted60d: 0.34,
          predicted90d: 0.40,
          description: "3 of 8 saturation divers have certification expiring within 60 days.",
          mitigation: "Recertification booked; backup divers from partner contractor on retainer.",
        },
      ],
      portfolioInsight:
